...
class _ChatListPageState extends State<ChatListPage> {
  ...
  Widget _buildChatListItem(Chat chat) {
    return ListTile(
      onTap: () async {
        // --- PERUBAHAN 1: Gunakan 'await' ---
        // Tunggu sampai halaman chat ditutup
        ...
        // --- PERUBAHAN 2: Panggil _loadChats SETELAH kembali ---
        // Ini akan me-refresh daftar chat dan memperbarui unread count.
        _loadChats();
      },
      leading: CircleAvatar(
        radius: 28,
        // --- PERUBAHAN 3: Gunakan nama variabel yang benar ---
      ...
      trailing: Column(
        ...
        children: [
          ...
          if (chat.unreadCount > 0)
            ...
            const SizedBox(height: 24), // Placeholder agar alignment tetap sama
        ],
      ),
    );
  }
